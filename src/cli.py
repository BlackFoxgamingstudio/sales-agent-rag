#!/usr/bin/env python3
"""
CLI entrypoint for sovereign-sales-agent-rag
"""
import sys
import json
import argparse
...
def main():
    parser = argparse.ArgumentParser(description="Autonomous sales qualification and B2B outreach agent. Integrates Swagger API specifications with ChromaDB vector search (`apiragbuiderv2.py`) to answer complex technical sales questions and qualify inbound leads.")
